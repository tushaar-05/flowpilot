...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'yellow' | 'dark';
  size?: 'sm' | 'md' | 'lg';
  children: ReactNode;
  loading?: boolean;
}
...
const variants = {
  ...
  dark: 'bg-ink text-white dark:bg-surface dark:text-ink dark:border-ink border-ink shadow-brutal-sm shadow-brutal-hover shadow-brutal-active',
